...
App::Import("QqAdapter.Url_class.php");
...
class Oauth{
	...
	function __construct($wb_akey , $wb_skey){
	...
	public function qq_callback($type,$keys){
		...
		$keysArr = array(
				...
				"client_id" =>  $this->wb_akey,
				"redirect_uri" => $keys['redirect_uri'],
				"client_secret" => $this->wb_skey,
				"code" => $keys['code']
		);

...
var bMobile=agent.indexOf('mobile')!==-1,isIE=false,isMozilla=/firefox/.test(agent),isSafari=/safari/.test(agent),isOpera=/opera/.test(agent);
if (isIE&&!$.support.leadingWhitespace ){
...
//var bMobile=agent.indexOf('mobile')!==-1,isIE=false,browerVer=9,isMozilla=true,isSafari=false,isOpera=false;
